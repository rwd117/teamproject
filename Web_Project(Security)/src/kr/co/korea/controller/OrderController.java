...
public class OrderController {
	...
	public String orderresult(OrderBean orderbean,Authentication authentication,OrderProductBean orderproductbean,
		...
		orderbean.setO_mIDx(userbean.getMidx());
	...
	public String orderlist(Model model,Authentication authentication) {
		SecurityMemberBeanDetails userbean = (SecurityMemberBeanDetails) authentication.getPrincipal();
		int o_mIDx =userbean.getMidx();
		OrderBean orderbean = new OrderBean();
		orderbean.setO_mlevel(userbean.getMlevel());
