				...
				<td	id="reviewWrite">
					<c:choose>
						<c:when test="${orders.oInvoice !=0 }">
							<button class="btn" onclick="location.href='${conPath}review/reviewwrite?o_ID=${vieworderbean.o_ID}&o_mIDx=${user.midx}&pID=${product.op_pID}'">리뷰작성</button>
			...
			<tr>
				<td class="lastrow">
					<form action="${conPath}orders/orderlist" method="get" >
						<input type="hidden" name="o_mIDx" id="o_mIDx" value="${user.midx }">				
