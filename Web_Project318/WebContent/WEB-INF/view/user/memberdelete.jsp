...
<script src="../js/6.js"></script>
 <script language="javascript">
        ...
        <script language="javascript">
        function showPopup() { window.open("${conPath}user/memberdelete_ok", "veiwimg", "width=500, height=300, left=300, top=500, toolbar=no,scrollbars=no,status=no,location=no"); }
		</script>
</head>
<body>
    <div id="join_wrap">
		<div id="join">
		<form:form action="${conPath }user/memberdelete_ok" method='post' modelAttribute="deleteUserBean">
		<table>
				<tr>
						<th>
