...
insert into board_info_table(board_info_idx, board_info_name) values (1, '��ǰ����');
insert into board_info_table(board_info_idx, board_info_name) values (2, '��۹���');
insert into board_info_table(board_info_idx, board_info_name) values (3, '��ǰ����');
insert into board_info_table(board_info_idx, board_info_name) values (4, '��ȯ����');
